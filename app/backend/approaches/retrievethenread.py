...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are an intelligent assistant supporting Research and Development consultants in enhancing analytical tools, process monitoring, and quality assurance across production and supply chains in Agri-food sector "
